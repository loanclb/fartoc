...
def check_answer():
    ...
    while answered == False:
        ...
        if answer =="energie":
            ...
            print("""Erreur, merci de vérifier la frappe
            """)
...
Ce programme me sert d'entraînement, j'apprends encore le python, inspiré du projet de Codecademy
